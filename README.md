...
### 3.1 Insights/graficos
    ...
    - Se calculan insights tales como ventas totales por tienda, ventas por categorias, productos mas y menos vendidos, valoracion promedio por tienda, valor de         envio promedio por tienda
### 3.2 Instrucciones para ejecutar el notebook
    - Descargar los archivos
    - Subir a google drive 
    - Localizar el archivo
    - Ejecutar archivo ( boton derecho sobre el mismo, abrir con google collab)
    - Conectar entorno
